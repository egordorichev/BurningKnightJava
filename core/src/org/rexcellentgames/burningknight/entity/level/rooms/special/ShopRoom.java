...
public class ShopRoom extends LockedRoom {
  ...
  private Pool getAccessoryPool() {
    switch (Player.instance.getType()) {
      case WARRIOR:
      default:
        return AccessoryPoolWarrior.instance;
      case WIZARD:
        return AccessoryPoolMage.instance;
      case RANGER:
        return AccessoryPoolRanger.instance;
    }
  }
  ...
  private Pool getWeaponPool() {
    switch (Player.instance.getType()) {
      case WARRIOR:
      default:
        return WeaponPoolWarrior.instance;
      case WIZARD:
        return WeaponPoolMage.instance;
      case RANGER:
        return WeaponPoolRanger.instance;
    }
  }
  ...
  private void paintMixed(int c) {
    ...
    for (int i = 0; i < c; i++) {
      switch (Random.newInt(3)) {
        case 0:
          items.add((Item) weapon.generate());
          break;
        case 1:
          items.add(ShopHatPool.instance.generate());
          break;
        case 2:
          items.add((Item) accessory.generate());
          break;
      }
    }
