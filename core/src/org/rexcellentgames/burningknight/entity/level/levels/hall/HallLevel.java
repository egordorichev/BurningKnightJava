...
public class HallLevel extends RegularLevel {
	...
	public String getMusic() {
		return Dungeon.depth == 0 ? "Gobbeon" : (Dungeon.depth == -1 ? "Outsider" : "Born to do rogueries");
	}

	@Override
	protected Painter getPainter() {
		return new HallPainter().setGrass(0.35f).setWater(0.35f).setDirt(0.35f).setCobweb(0.1f);
	}
}