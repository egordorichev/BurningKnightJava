...
object ItemRegistry {
  ...
  val items = mapOf(
    ...
    "spectacles" to Pair(Spectacles::class.java, 1f, 1f, 1f, 1f, Quality.IRON),
    "diamond" to Pair(Diamond::class.java, 1f, 1f, 1f, 1f, Quality.GOLDEN),
    ...
    "meetboy_axe" to Pair(MeetboyAxe::class.java, 1f, 0.3f, 0.3f, 1f, Quality.GOLDEN),
    "star" to Pair(Star::class.java, 1f, 1f, 1f, 1f, Quality.IRON),
    "blue_watch" to Pair(BlueWatch::class.java, 1f, 1f, 1f, 1f, Quality.WOODEN),
    "stopwatch" to Pair(StopWatch::class.java, 1f, 1f, 1f, 1f, Quality.IRON),
    ...
    "ammo_orbital" to Pair(AmmoOrbital::class.java, 1f, 1f, 1f, 1f, Quality.IRON),
    ...
    "sword_orbital" to Pair(SwordOrbital::class.java, 1f, 1f, 1f, 1f, Quality.GOLDEN),
    "dew_vial" to Pair(DewVial::class.java, 1f, 1f, 1f, 1f, Quality.IRON),
    ...
    "wings" to Pair(Wings::class.java, 1f, 1f, 1f, 1f, Quality.GOLDEN),
    ...
    "waterbolt" to Pair(Waterbolt::class.java, 0.8f, 0.3f, 1f, 0.3f, Quality.IRON),
    ...
    "halo" to Pair(Halo::class.java, 1f, 1f, 1f, 1f, Quality.GOLDEN),
    ...
    "diamond_sword" to Pair(DiamondSword::class.java, 1f, 1f, 0.3f, 0.1f, Quality.GOLDEN),
    "blood_crown" to Pair(BloodCrown::class.java, 1f, 1f, 1f, 1f, Quality.GOLDEN),
    ...
    "crash_book" to Pair(SuperCrazyBook::class.java, 0.3f, 0.1f, 1f, 0.1f, Quality.GOLDEN),
    ...
    "kotling_gun" to Pair(KotlingGun::class.java, 0.1f, 0.3f, 0.1f, 1f, Quality.WOODEN),
    ...
    "triple_machine_gun" to Pair(TripleMachineGun::class.java, 1f, 0.3f, 0.3f, 1f, Quality.GOLDEN),
	  ...
	  "money_printer" to Pair(MoneyPrinter::class.java, 1f, 0.3f, 0.1f, 1f, Quality.IRON),
	  ...
	  "mimic_totem" to Pair(MimicTotem::class.java, 1f, 1f, 1f, 1f, Quality.IRON),
