...
public class WoodenChestPool extends Pool<Item> {
	...
	public WoodenChestPool() {
		switch (Player.instance.type) {
			case WARRIOR: addFrom(AccessoryPoolWarrior.instance); break;
			case WIZARD: addFrom(AccessoryPoolMage.instance); break;
			case RANGER: addFrom(AccessoryPoolRanger.instance); break;
		}
