...
public class Collisions implements ContactListener, ContactFilter {
	...
	public void beginContact(Contact contact) {
		...
		if (a instanceof Level && !(b instanceof DashingKnight || b instanceof Hedgehog || b instanceof Thief || b instanceof Roller || b instanceof Vacuum)) {
			return;
		} else if (b instanceof Level && !(a instanceof DashingKnight || a instanceof Hedgehog || a instanceof Thief || a instanceof Roller || a instanceof Vacuum)) {
			return;
		}
