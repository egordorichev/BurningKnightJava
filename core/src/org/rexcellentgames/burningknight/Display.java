...
public class Display {
	...
	public static final float UI_SCALE = 1f;
	...
	public static final int UI_WIDTH_MIN = (int) (GAME_WIDTH * 0.5f);
	public static final int UI_HEIGHT_MIN = (int) (GAME_HEIGHT * 0.5f);
}