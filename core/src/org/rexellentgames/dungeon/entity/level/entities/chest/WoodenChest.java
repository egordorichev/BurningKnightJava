...
public class WoodenChest extends Chest {
	...
	private static ArrayList<Class<? extends Item>>[] items = new ArrayList[] {
		...
		new ArrayList(Arrays.asList(SwordA.class, DaggerB.class, SwordB.class, AxeA.class, ButcherA.class, MorningStarA.class, Compass.class)),
		new ArrayList(Arrays.asList(SwordB.class, DaggerC.class, SwordC.class, AxeB.class, ButcherB.class, MorningStarB.class, Compass.class)),
		new ArrayList(Arrays.asList(AxeD.class, SwordC.class, AxeC.class, ButcherC.class, MorningStarC.class, Compass.class)),
		new ArrayList(Arrays.asList(AxeD.class, Compass.class))
	};

	private static float[][] chances = new float[][] {
		{ 1 },
		{ 1, 0.3f, 0.1f, 1, 1, 0.8f, 0.3f },
		{ 1, 0.3f, 0.1f, 1.2f, 1, 1f, 1f },
		{ 0.1f, 1, 1.2f, 1, 1f, 1f },
		{ 1, 1f }
	};
	...
	public Item generate() {
		try {
			Log.info("Generating item for depth " + Dungeon.depth);
