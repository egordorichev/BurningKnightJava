...
public class WoodenChest extends Chest {
	...
	private static ArrayList<Class<? extends Item>>[] items = new ArrayList[] {
		...
		new ArrayList(Arrays.asList(SwordB.class, DaggerC.class, SwordC.class, AxeB.class, ButcherB.class, MorningStarB.class, Compass.class, GunB.class, BowB.class, MoaiHat.class, GoldHat.class, RocketLauncherB.class)),
		new ArrayList(Arrays.asList(AxeD.class, SwordC.class, AxeC.class, ButcherC.class, MorningStarC.class, Compass.class, GunC.class, BowB.class, DunceHat.class, RubyHat.class, RocketLauncherC.class)),
	...
	private static float[][] chances = new float[][] {
		...
		{ 1, 0.3f, 0.1f, 1.2f, 1, 1f, 1f, 1f, 1f, 1f, 0.3f, 1f },
		{ 0.1f, 1, 1.2f, 1, 1f, 1f, 1f, 1f, 1f, 0.1f, 1f },
		{ 1, 1f }
	};
