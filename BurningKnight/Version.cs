...
namespace BurningKnight
{
  public static class Version
  {
    ...
    private static readonly List<string> _titles = new List<string>(new[]
    {
      "Fireproof",
      "Might burn",
      "'Friendly' fire",
    ...
    static Version()
    {
      if (Random.Chance(0.1f)) _titles.Add("You feel lucky");

      if (Random.Chance(0.01f)) _titles.Add("You feel very lucky");

      if (Random.Chance(0.001f)) _titles.Add("This title should never appear");
    }
